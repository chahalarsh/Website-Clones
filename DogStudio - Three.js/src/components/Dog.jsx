...
const Dog = () => {
    ...
    const [normalMap, sampleMatCap] = useTexture(["/dog_normals.jpg", "/matcap/mat-2.png", "/branches_diffuse.jpeg", "/branches_normals.jpeg"])
        .map(texture => {
    ...
    return (
        <>
            <primitive object={model.scene} position={[0.1, -0.5, 0]} rotation={[0, 0.8, 0]} />
